        ...
        <div id="layoutSidenav_content">
            <main>
                    ...
                    <div class="container-fluid">
                        <div class="page-header-content">
                            <h1 class="page-header-title">
                                ...
                                <span>Ajouter nouveau evenement</span>
                            </h1>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid mt-n10">
                    <div class="card mb-4">
                        <div class="card-header">Ajouter nouveau evenement</div>
                        <div class="card-body">
                            ...
                            <form action="add-new-event.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="Picture"> image: (copier le nom du dossier img/evenement)</label>
